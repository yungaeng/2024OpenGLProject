...
void Robot::updatePartTransforms() {
    ...
    // 왼쪽 다리 변환
    leftLeg->_trs = glm::translate(glm::mat4(1.f), glm::vec3(-0.5f, 0.f, 0.f));
    leftLeg->_scale = glm::scale(glm::mat4(1.f), glm::vec3(0.5f, 1.f, 0.5f));

    // 오른쪽 다리 변환
    rightLeg->_trs = glm::translate(glm::mat4(1.f), glm::vec3(0.5f, 0.f, 0.f));
    rightLeg->_scale = glm::scale(glm::mat4(1.f), glm::vec3(0.5f, 1.f, 0.5f));

    // 왼쪽 팔 변환
    leftArm->_trs = glm::translate(glm::mat4(1.f), glm::vec3(-1.f, 1.5f, 0.f));
    leftArm->_scale = glm::scale(glm::mat4(1.f), glm::vec3(0.5f, 1.f, 0.5f));

    // 오른쪽 팔 변환
    rightArm->_trs = glm::translate(glm::mat4(1.f), glm::vec3(1.f, 1.5f, 0.f));
